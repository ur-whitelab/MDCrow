...
class MDCrowEnv(Environment[None]):
    ...
    async def reset(self) -> tuple[Messages, list[Tool]]:
        ...
        self.tools = [
            ...
            Tool.from_function(GetTurnsBetaSheetsHelices),
            Tool.from_function(GetActiveSites),
            Tool.from_function(GetAllKnownSites),
            Tool.from_function(GetAllSequences),
            Tool.from_function(GetBindingSites),
            Tool.from_function(GetGeneNames),
            Tool.from_function(GetInteractions),
            Tool.from_function(GetKineticProperties),
            Tool.from_function(GetPDB3DInfo),
            Tool.from_function(GetPDBProcessingInfo),
            Tool.from_function(GetProteinAssociatedKeywords),
            Tool.from_function(GetProteinFunction),
                ...
                [
                    Message(
                        content=(
                            ...
                            f" {compute_solvent_accessible_surface_area.__name__} or"
